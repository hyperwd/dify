const translation = {
  ...
  licenseExpiredTip: '您所在空间的 Coop Enterprise 许可证已过期，请联系管理员以继续使用 Coop。',
  licenseLost: '许可证丢失',
  licenseLostTip: '无法连接 Coop 许可证服务器，请联系管理员以继续使用 Coop。',
  licenseInactive: '许可证未激活',
  licenseInactiveTip: '您所在空间的 Coop Enterprise 许可证尚未激活，请联系管理员以继续使用 Coop。',
  webapp: {
    login: '登录',
