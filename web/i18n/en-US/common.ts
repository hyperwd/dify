const translation = {
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Coop to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Coop allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Coop\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Coop {{version}} is now available.',
    latestAvailable: 'Coop {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
