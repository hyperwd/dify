const translation = {
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Coop and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Coop Enterprise license for your workspace has expired. Please contact your administrator to continue using Coop.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Coop license server. Please contact your administrator to continue using Coop.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Coop Enterprise license for your workspace is inactive. Please contact your administrator to continue using Coop.',
  webapp: {
    login: 'Login',
