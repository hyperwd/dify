const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to Coop citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Coop will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
