...
import CoopLogo from './coop-logo'
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Brand assets rendered in different contexts. CoopLogo adapts to the active theme while other variants target specific surfaces.',
      },
    },
  },
  args: {
  ...
  tags: ['autodocs'],
} satisfies Meta<typeof CoopLogo>
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between rounded-xl border border-divider-subtle bg-background-default p-4">
              <CoopLogo size={size} style={style} />
